...
Proof.
  ...
  rewrite lookup_list_to_map_gen. *)
  (* assert (Hf' : forall kv kv', kv ∈ map_to_list m -> kv' ∈ map_to_list m ->
    )
...
(* Lemma sized_inputs_compose_sized_graphs_aux {N T n m o}
  ...
  sized_inputs (compose_sized_graphs_aux scohg scohg') =
  sized_inputs scohg.
Proof.
Admitted. *)
