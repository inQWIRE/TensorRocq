...
Definition tensorequation_semantics mabs mg teeq : Prop :=
  tensorequation_semantics_aux mabs mg [] teeq.(te_lhs) teeq.(te_rhs)
    (map_to_list teeq.(te_univ)) ∅.
